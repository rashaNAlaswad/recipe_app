...
MealDetailModel _$MealDetailModelFromJson(Map<String, dynamic> json) =>
    MealDetailModel(
...
Map<String, dynamic> _$MealDetailModelToJson(MealDetailModel instance) =>
    <String, dynamic>{
...
MealDetailResponse _$MealDetailResponseFromJson(Map<String, dynamic> json) =>
    MealDetailResponse(
      meals: (json['meals'] as List<dynamic>?)
          ?.map((e) => MealDetailModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
